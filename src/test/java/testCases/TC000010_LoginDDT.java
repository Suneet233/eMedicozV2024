...
public class TC000010_LoginDDT extends BaseClassSomeChangesCrossBrowserandConfigFilesAdd {
	
	@Test(dataProvider="LoginData", dataProviderClass = DataProviders.class) // yaha add kiya hai humne  getting data providers from diffrent class 
